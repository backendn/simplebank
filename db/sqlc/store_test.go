...
func TestTransferTx(t *testing.T) {
	...
	results := make(chan TransferTxResultParams)
	...
	for i := 0; i < n; i++ {
		...
		require.Equal(t, account1.Balance, fromAccount.Balance+diff1)
		require.Equal(t, account2.Balance, toAccount.Balance-diff2)
